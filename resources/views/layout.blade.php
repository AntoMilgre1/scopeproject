...
<head>
    ...
    <!-- Favicon -->
    <link href="img/bird.ico" rel="icon">
        ...
        <div class="container-xxl position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0 nav-list">
                        <a href="/" class="nav-item nav-link  ">Home</a>
                        <a id="aca" href="about" class="nav-item nav-link">About Us</a>
                        ...
                        <a href="login"  class="nav-item nav-link" >Login</a>
                            ...
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Students Dashboard</a>
                            <div class="dropdown-menu m-0">
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-map-marker-alt me-3"></i>Thambanoor,Trivandrum</p>
                        <p><i class="fa fa-phone-alt me-3"></i>+012 345 67890</p>
                        <p><i class="fa fa-envelope me-3"></i>info@scopeindia.org</p>
                        <div class="d-flex pt-2">
                            
                            <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/scopeindia.org/"><i class="fab fa-facebook-f"></i></a>
